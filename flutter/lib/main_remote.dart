...
import 'package:shopremote2/common/widgets/overlay.dart';
import 'package:shopremote2/desktop/pages/desktop_tab_page.dart';
import 'package:shopremote2/desktop/pages/install_page.dart';
import 'package:shopremote2/desktop/pages/server_page.dart';
import 'package:shopremote2/desktop/screen/desktop_file_transfer_screen.dart';
import 'package:shopremote2/desktop/screen/desktop_view_camera_screen.dart';
import 'package:shopremote2/desktop/screen/desktop_port_forward_screen.dart';
import 'package:shopremote2/desktop/screen/desktop_remote_screen.dart';
import 'package:shopremote2/desktop/screen/desktop_terminal_screen.dart';
...
import 'package:shopremote2/plugin/handlers.dart'
    if (dart.library.html) 'package:shopremote2/web/plugin/handlers.dart';
...
Future<void> main(List<String> args) async {
  ...
  debugPrint("launch args (remote-only): $args");
  kBootArgs = List.from(args);

  // Set remote-only mode flag
  isRemoteOnly = true;
  isHostOnly = false;
...
void runMainApp(bool startService) async {
  ...
  windowManager.waitUntilReadyToShow(windowOptions, () async {
    ...
    // Remote-only mode: window is resizable
    setResizable(true);
  });
}
