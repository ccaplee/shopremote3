...
List<TTextMenu> toolbarControls(BuildContext context, String id, FFI ffi) {
  ...
  // https://github.com/ccaplee/shopremote2/pull/9731
...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isShopRemote3Idd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  if (pi.isShopRemote3Idd) {
    final virtualDisplays = ffi.ffiModel.pi.ShopRemote3VirtualDisplays;
