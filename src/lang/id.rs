...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke ShopRemote3..."),
        ...
        ("install_tip", "Karena UAC, ShopRemote3 tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal ShopRemote3 ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk ShopRemote3."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk ShopRemote3."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd ShopRemote3 untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input ShopRemote3]."),
        ...
        ("Language", "Bahasa"),
        ("Keep ShopRemote3 background service", "Pertahankan ShopRemote3 berjalan pada service background"),
        ...
        ("Show ShopRemote3", "Tampilkan ShopRemote3"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada ShopRemote3"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada ShopRemote3"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC ShopRemote3 yang sedang berjalan"),
        ...
        ("verify_shopremote2_password_tip", "Verifikasi Kata Sandi ShopRemote3"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan ShopRemote3, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Silahkan perbarui ShopRemote3 Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah ShopRemote3 berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh ShopRemote3"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela ShopRemote3 sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service ShopRemote3 agar tetap aktif"),
        ...
        ("About ShopRemote3", "Tentang ShopRemote3"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Silahkan perbarui aplikasi ShopRemote3 ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
