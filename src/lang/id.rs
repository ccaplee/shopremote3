...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke ShopRemote2..."),
        ...
        ("install_tip", "Karena UAC, ShopRemote2 tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal ShopRemote2 ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk ShopRemote2."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk ShopRemote2."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd ShopRemote2 untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input ShopRemote2]."),
        ...
        ("Language", "Bahasa"),
        ("Keep ShopRemote2 background service", "Pertahankan ShopRemote2 berjalan pada service background"),
        ...
        ("Show ShopRemote2", "Tampilkan ShopRemote2"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada ShopRemote2"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada ShopRemote2"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC ShopRemote2 yang sedang berjalan"),
        ...
        ("verify_shopremote2_password_tip", "Verifikasi Kata Sandi ShopRemote2"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan ShopRemote2, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Silahkan perbarui ShopRemote2 Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah ShopRemote2 berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh ShopRemote2"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela ShopRemote2 sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service ShopRemote2 agar tetap aktif"),
        ...
        ("About ShopRemote2", "Tentang ShopRemote2"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Silahkan perbarui aplikasi ShopRemote2 ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
