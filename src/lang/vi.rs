...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới ShopRemote2..."),
        ...
        ("install_tip", "Do cơ chế UAC, ShopRemote2 có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt ShopRemote2 vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho ShopRemote2."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho ShopRemote2."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [ShopRemote2 Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep ShopRemote2 background service", "Giữ dịch vụ ShopRemote2 chạy nền"),
        ...
        ("Show ShopRemote2", "Hiện ShopRemote2"),
        ...
        ("verify_shopremote2_password_tip", "Xác thực mật khẩu ShopRemote2"),
        ...
        ("scam_text2", "Chỉ sử dụng ShopRemote2 với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ ShopRemote2 mở"),
        ...
        ("floating_window_tip", "Giữ ShopRemote2 trên cùng"),
        ...
        ("About ShopRemote2", "Về ShopRemote2"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
