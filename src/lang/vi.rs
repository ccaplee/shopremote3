...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới ShopRemote3..."),
        ...
        ("install_tip", "Do cơ chế UAC, ShopRemote3 có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt ShopRemote3 vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho ShopRemote3."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho ShopRemote3."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [ShopRemote3 Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep ShopRemote3 background service", "Giữ dịch vụ ShopRemote3 chạy nền"),
        ...
        ("Show ShopRemote3", "Hiện ShopRemote3"),
        ...
        ("verify_shopremote2_password_tip", "Xác thực mật khẩu ShopRemote3"),
        ...
        ("scam_text2", "Chỉ sử dụng ShopRemote3 với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ ShopRemote3 mở"),
        ...
        ("floating_window_tip", "Giữ ShopRemote3 trên cùng"),
        ...
        ("About ShopRemote3", "Về ShopRemote3"),
