...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till ShopRemote2..."),
        ...
        ("install_tip", "På grund av UAC, kan inte ShopRemote2 fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera ShopRemote2 på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge ShopRemote2 \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge ShopRemote2 \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [ShopRemote2 Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep ShopRemote2 background service", "Behåll ShopRemote2 i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa ShopRemote2 programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show ShopRemote2", "Visa ShopRemote2"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
