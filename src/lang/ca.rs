...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de ShopRemote3..."),
        ...
        ("install_tip", "En alguns casos és possible que el ShopRemote3 no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el ShopRemote3 al vostre sistema."),
        ("Click to upgrade", "Feu clic per a actualitzar"),
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al ShopRemote3 els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al ShopRemote3 els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al ShopRemote3 l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «ShopRemote3 Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep ShopRemote3 background service", "Manté el servei del ShopRemote3 en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del ShopRemote3, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el ShopRemote3 al dispositiu remot."),
        ...
        ("Show ShopRemote3", "Mostra el ShopRemote3"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al ShopRemote3 els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al ShopRemote3 els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del ShopRemote3 en execució."),
        ...
        ("verify_shopremote2_password_tip", "Verifica la contrasenya del ShopRemote3"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del ShopRemote3, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Actualitzeu el ShopRemote3 Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el ShopRemote3 funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de ShopRemote3"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del ShopRemote3 està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del ShopRemote3 en rerefons"),
        ...
        ("About ShopRemote3", "Quant al ShopRemote3"),
