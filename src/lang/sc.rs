...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete ShopRemote3..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), ShopRemote3 diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare ShopRemote3 a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a ShopRemote3 su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a ShopRemote3 su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a ShopRemote3 de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada ShopRemote3]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep ShopRemote3 background service", "Mantene su servìtziu de ShopRemote3 in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione ShopRemote3, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("Show ShopRemote3", "Mustra ShopRemote3"),
        ("This PC", "Custu PC"),
        ("or", "O"),
        ("Elevate", "Cresche"),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a ShopRemote3 sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a ShopRemote3."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de ShopRemote3."),
        ...
        ("verify_shopremote2_password_tip", "Cunfirma sa crae de ShopRemote3"),
        ...
        ("Exit", "Essi dae ShopRemote3"),
        ("Open", "Aberi ShopRemote3"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare ShopRemote3 e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Atualiza ShopRemote3 Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de ShopRemote3 comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae ShopRemote3"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana ShopRemote3 est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de ShopRemote3"),
        ...
        ("About ShopRemote3", "Informatziones subra de ShopRemote3"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Atualiza su cliente ShopRemote3 remotu a sa versione {} o prus noa!"),
