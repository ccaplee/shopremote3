...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établie"),
        ("connecting_status", "Connexion au réseau ShopRemote2…"),
        ...
        ("install_tip", "ShopRemote2 n’est pas installé, ce qui peut limiter son utilisation à cause de l’UAC. Cliquez ci-dessous pour l’installer."),
        ...
        ("android_input_permission_tip1", "Pour qu’un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher d’écran, vous devez autoriser ShopRemote2 à utiliser le service « Accessibilité »."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, puis recherchez et accédez à la section [Services installés] ; activez ensuite le service [ShopRemote2 Input]."),
        ...
        ("Language", "Langue"),
        ("Keep ShopRemote2 background service", "Garder le service ShopRemote2 en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l’application ShopRemote2, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("Show ShopRemote2", "Afficher ShopRemote2"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Vous devez accorder à ShopRemote2 l’autorisation « Surveillance de l’entrée » pour contrôler le bureau distant avec le clavier."),
        ("config_microphone", "Vous devez accorder à ShopRemote2 l’autorisation « Enregistrer l’audio » pour discuter à distance."),
        ...
        ("still_click_uac_tip", "L’utilisateur distant devra malgré tout confirmer l’UAC de l’instance ShopRemote2 en cours d’éxécution."),
        ...
        ("verify_shopremote2_password_tip", "Vérifier le mot de passe ShopRemote2"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu’un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N’AVEZ PAS CONFIANCE et qui vous a demandé d’utiliser ShopRemote2 et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Veuillez mettre à jour ShopRemote2 Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher ShopRemote2 de fonctionner correctement sur la machine contrôlée."),
        ...
        ("powered_by_me", "Utilise la technologie ShopRemote2"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre ShopRemote2 est ouverte"),
        ...
        ("About ShopRemote2", "À propos de ShopRemote2"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Veuillez mettre le client ShopRemote2 distant à jour vers la version {} ou ultérieure !"),
        ...
        ("allow-insecure-tls-fallback-tip", "Par défaut, ShopRemote2 vérifie le certificat du serveur lors de l’utilisation de protocoles utilisant TLS.\nLorsque cette option est activée, ShopRemote2 autorise les connexions même en cas d’échec de l’étape de vérification."),
        ("Disable UDP", "Désactiver UDP"),
        ("disable-udp-tip", "Contrôle l’utilisation exclusive du mode TCP.\nLorsque cette option est activée, ShopRemote2 n’utilise plus le port UDP 21116 et utilise le port TCP 21116 à la place."),
        ("server-oss-not-support-tip", "Note : Cette fonctionnalité n’est pas disponible sous la version open-source du serveur ShopRemote2."),
