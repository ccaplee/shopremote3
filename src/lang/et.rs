...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "ShopRemote3i võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa ShopRemote3 mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et ShopRemote3 oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb ShopRemote3ile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb ShopRemote3ile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma ShopRemote3ile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [ShopRemote3 Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep ShopRemote3 background service", "Säilita ShopRemote3i taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele ShopRemote3i rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show ShopRemote3", "Kuva ShopRemote3"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma ShopRemote3ile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma ShopRemote3ile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud ShopRemote3i kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_shopremote2_password_tip", "Kinnita ShopRemote3i parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul ShopRemote3i kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Palun täienda ShopRemote3 Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib ShopRemote3il takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb ShopRemote3il"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui ShopRemote3i aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada ShopRemote3i taustateenust."),
        ...
        ("About ShopRemote3", "ShopRemote3i teave"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Täiendage ShopRemote3i klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
