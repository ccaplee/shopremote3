...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "ShopRemote2i võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa ShopRemote2 mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et ShopRemote2 oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb ShopRemote2ile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb ShopRemote2ile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma ShopRemote2ile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [ShopRemote2 Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep ShopRemote2 background service", "Säilita ShopRemote2i taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele ShopRemote2i rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show ShopRemote2", "Kuva ShopRemote2"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma ShopRemote2ile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma ShopRemote2ile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud ShopRemote2i kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_shopremote2_password_tip", "Kinnita ShopRemote2i parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul ShopRemote2i kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Palun täienda ShopRemote2 Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib ShopRemote2il takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb ShopRemote2il"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui ShopRemote2i aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada ShopRemote2i taustateenust."),
        ...
        ("About ShopRemote2", "ShopRemote2i teave"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Täiendage ShopRemote2i klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
