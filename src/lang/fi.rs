...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään ShopRemote3 verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa ShopRemote3 ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi ShopRemote3in järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava ShopRemote3ille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava ShopRemote3ille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten ShopRemote3 daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota ShopRemote3ille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli ShopRemote3 ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "ShopRemote3 palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa ShopRemote3in asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "ShopRemote3 palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep ShopRemote3 background service", "Pidä ShopRemote3in taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista ShopRemote3in akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show ShopRemote3", "Näytä ShopRemote3"),
        ...
        ("verify_shopremote2_password_tip", "Vahvista ShopRemote3 salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "ShopRemote3 ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Päivitä ShopRemote3 Server Pro versioon {} jatkaaksesi."),
        ...
        ("About ShopRemote3", "Tietoa ShopRemote3istä"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Päivitä etä-ShopRemote3-asiakasversioon {} yhteensopivuuden takaamiseksi"),
