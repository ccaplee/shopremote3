...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään ShopRemote2 verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa ShopRemote2 ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi ShopRemote2in järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava ShopRemote2ille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava ShopRemote2ille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten ShopRemote2 daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota ShopRemote2ille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli ShopRemote2 ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "ShopRemote2 palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa ShopRemote2in asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "ShopRemote2 palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep ShopRemote2 background service", "Pidä ShopRemote2in taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista ShopRemote2in akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show ShopRemote2", "Näytä ShopRemote2"),
        ...
        ("verify_shopremote2_password_tip", "Vahvista ShopRemote2 salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "ShopRemote2 ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Päivitä ShopRemote2 Server Pro versioon {} jatkaaksesi."),
        ...
        ("About ShopRemote2", "Tietoa ShopRemote2istä"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Päivitä etä-ShopRemote2-asiakasversioon {} yhteensopivuuden takaamiseksi"),
