...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem ShopRemote2..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, ShopRemote2 v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate ShopRemote2u dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate ShopRemote2u dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno ShopRemote2u dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »ShopRemote2 Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep ShopRemote2 background service", "Ohrani ShopRemote2ovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije ShopRemote2, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "ShopRemote2 potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "ShopRemote2 potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_shopremote2_password_tip", "Preveri geslo za ShopRemote2"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite ShopRemote2, prekinite klic in program zaprite."),
        ("scam_text2", "ShopRemote2 omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Prosimo, nadgradite ShopRemote2 Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo ShopRemote2"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno ShopRemote2a odprto"),
        ...
        ("floating_window_tip", "Pomaga pri ShopRemote2 storitvi v ozadju"),
        ...
        ("About ShopRemote2", "O ShopRemote2u"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Prosimo, nadgradite ShopRemote2 odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
