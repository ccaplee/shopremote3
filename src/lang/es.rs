...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red ShopRemote2 en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que ShopRemote2 no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar ShopRemote2 a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a ShopRemote2 de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a ShopRemote2 de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que ShopRemote2 use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [ShopRemote2 Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep ShopRemote2 background service", "Dejar ShopRemote2 como Servicio en 2do plano"),
        ...
        ("Show ShopRemote2", "Mostrar ShopRemote2"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a ShopRemote2 permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a ShopRemote2 permisos de \"Grabar Audio\"."),
        ...
        ("verify_shopremote2_password_tip", "Verificar la contraseña de ShopRemote2"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses ShopRemote2 e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "¡Por favor, actualiza ShopRemote2 Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que ShopRemote2 no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de ShopRemote2"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de ShopRemote2 de fondo"),
        ...
        ("About ShopRemote2", "Acerca de ShopRemote2"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Por favor, actualiza el cliente ShopRemote2 a la versión {} o superior en el lado remoto"),
