...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the ShopRemote3 network..."),
        ...
        ("Slogan_tip", "안전하고 빠른 원격 데스크톱, ShopRemote3"),
        ...
        ("install_tip", "Due to UAC, ShopRemote3 can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install ShopRemote3 to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant ShopRemote3 \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant ShopRemote3 \"Screen Recording\" permissions."),
        ...
        ("setup_server_tip", "Change connection server"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow ShopRemote3 to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [ShopRemote3 Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next ShopRemote3 application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant ShopRemote3 \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant ShopRemote3 \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running ShopRemote3."),
        ...
        ("verify_shopremote2_password_tip", "Verify ShopRemote3 password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use ShopRemote3 and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Please upgrade ShopRemote3 Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent ShopRemote3 from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by ShopRemote3"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if ShopRemote3 window is open"),
        ...
        ("floating_window_tip", "It helps to keep ShopRemote3 background service"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Please upgrade the ShopRemote3 client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, ShopRemote3 verifies the server certificate for protocols using TLS.\nWith this option enabled, ShopRemote3 will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, ShopRemote3 will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: ShopRemote3 server OSS doesn't include this feature."),
