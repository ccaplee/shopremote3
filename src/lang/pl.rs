...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "ShopRemote2 może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować ShopRemote2 w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić ShopRemote2 przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić ShopRemote2 na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [ShopRemote2 Input]."),
        ...
        ("Language", "Język"),
        ("Keep ShopRemote2 background service", "Zachowaj usługę ShopRemote2 w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji ShopRemote2, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show ShopRemote2", "Pokaż ShopRemote2"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji ShopRemote2 uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać ShopRemote2 uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z ShopRemote2 w Twojej sieci."),
        ...
        ("verify_shopremote2_password_tip", "Weryfikuj hasło ShopRemote2"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu ShopRemote2 - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Proszę zaktualizować ShopRemote2 Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu ShopRemote2 po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez ShopRemote2"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno ShopRemote2 jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę ShopRemote2 w tle"),
        ...
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Proszę zaktualizować zdalny klient ShopRemote2 do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie ShopRemote2 weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, ShopRemote2 pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, ShopRemote2 nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS ShopRemote2 nie obsługuje tej funkcji."),
