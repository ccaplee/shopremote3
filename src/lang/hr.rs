...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na ShopRemote3 mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a ShopRemote3 ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate ShopRemote3 na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, ShopRemote3-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, ShopRemote3-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti ShopRemote3-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [ShopRemote3 Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep ShopRemote3 background service", "Zadrži ShopRemote3 kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje ShopRemote3 aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show ShopRemote3", "Prikaži ShopRemote3"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti ShopRemote3u dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti ShopRemote3u \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog ShopRemote3a."),
        ...
        ("verify_shopremote2_password_tip", "Provjera lozinke za ShopRemote3"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete ShopRemote3, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_shopremote2_server_pro_to_{}_tip", "Ažurirajte ShopRemote3 Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti ShopRemote3 da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće ShopRemote3"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_shopremote2_client_to_{}_tip", "Molimo ažurirajte ShopRemote3 klijent na verziju {} ili noviju na udaljenoj strani!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
