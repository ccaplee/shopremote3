...
///
/// Note:
/// On linux, we use dbus to communicate multiple shopremote2 process.
...
const DBUS_NAME: &str = "org.shopremote2.shopremote2";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ShopRemote2 DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.shopremote2.shopremote2 /dbus org.shopremote2.shopremote2.NewConnection string:'PEER_ID'`
