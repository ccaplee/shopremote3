...
// https://github.com/ccaplee/shopremote2/issues/9729
...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // It looks like https://github.com/ccaplee/shopremote2/issues/9729#issuecomment-2432306822
            // 1. Press "Command" key in ShopRemote3
            // 2. Move the physical mouse
            // 3. Press "V" key in ShopRemote3
            ...
            // we consider only ShopRemote3 operates the controlled side.
            //
...
fn key_sleep() {
    ...
    // Though `/Applications/ShopRemote3.app/Contents/MacOS/shopremote2 --server` in terminal is ok.
    let now = Instant::now();
...
fn get_modifier_state(key: Key, en: &mut Enigo) -> bool {
    // https://github.com/ccaplee/shopremote2/issues/332
...
// https://github.com/ccaplee/shopremote2/issues/3928#issuecomment-1496936687
// https://github.com/ccaplee/shopremote2/issues/3928#issuecomment-1500415822
// https://github.com/ccaplee/shopremote2/issues/3928#issuecomment-1500773473
#[cfg(any(target_os = "windows", target_os = "linux"))]
