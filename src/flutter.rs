...
// FFI for shopremote2 core's main entry.
...
#[cfg(windows)]
#[no_mangle]
pub extern "C" fn shopremote2_core_main_args(args_len: *mut c_int) -> *mut *mut c_char {
...
#[cfg(windows)]
#[no_mangle]
pub unsafe extern "C" fn get_shopremote2_app_name(buffer: *mut u16, length: i32) -> i32 {
