...
pub fn check_ws(endpoint: &str) -> String {
    ...
    let (relay, dst_port) = if endpoint_port == rendezvous_port {
        ...
        // relay
        // https://github.com/ccaplee/shopremote2/blob/6ffbcd1375771f2482ec4810680623a269be70f1/src/rendezvous_mediator.rs#L615
        // https://github.com/ccaplee/shopremote2-server/blob/235a3c326ceb665e941edb50ab79faa1208f7507/src/relay_server.rs#L83, based on relay port.
...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("ai.ilv.co.kr:21115"), "ws://ai.ilv.co.kr/ws/id");
        assert_eq!(check_ws("ai.ilv.co.kr:21116"), "ws://ai.ilv.co.kr/ws/id");
        assert_eq!(check_ws("ai.ilv.co.kr:21117"), "ws://ai.ilv.co.kr/ws/relay");
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://api.ai.ilv.co.kr".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(check_ws("ai.ilv.co.kr:21115"), "wss://ai.ilv.co.kr/ws/id");
        assert_eq!(check_ws("ai.ilv.co.kr:21116"), "wss://ai.ilv.co.kr/ws/id");
        assert_eq!(
            check_ws("ai.ilv.co.kr:21117"),
            "wss://ai.ilv.co.kr/ws/relay"
        );
