...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("shopremote2".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../shopremote2-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\shopremote2\flutter\build\windows\runner\Debug\ -o . -e ..\shopremote2\flutter\build\windows\runner\Debug\shopremote2.exe
